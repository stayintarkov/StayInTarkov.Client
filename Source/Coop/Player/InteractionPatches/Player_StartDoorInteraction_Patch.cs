...
//            {
//                Logger.LogError($"Player_ExecuteDoorInteraction_Patch:Replicated:Could not find {nameof(SITGameComponent)}");
//                return;
//            }

//            if (!ItemFinder.TryFindItemController(player.ProfileId, out TraderControllerClass itemController))
//            {
//                Logger.LogError($"Player_ExecuteDoorInteraction_Patch:Replicated:Could not find {nameof(itemController)}");
//                return;
//            }
...
//            {
//                Logger.LogError($"Player_ExecuteDoorInteraction_Patch:Replicated:Could not find {nameof(worldInteractiveObject)}");
//                return;
//            }
...
//                foreach (var player in world.RegisteredPlayers.Select(x => (EFT.Player)x))
//                    if (player.CurrentManagedState == movementState)
//                        return player;


//            Logger.LogError($"Player_StartDoorInteraction_Patch:GetPlayerByMovementState. Unable to find correct Player Movement State");
//            return null;
//        }
//    }
//}