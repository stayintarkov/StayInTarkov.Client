...
//        {
//            GetLogger(typeof(Player_Proceed_Meds_Patch)).LogDebug($"{nameof(Player_Proceed_Meds_Patch)}.{nameof(Replicated)}");
//            if (!dict.ContainsKey("data")) 
//            {
//                GetLogger(typeof(Player_Proceed_Meds_Patch)).LogError($"{nameof(Player_Proceed_Meds_Patch)}.{nameof(Replicated)}. no data found");
//                return;
//            }
