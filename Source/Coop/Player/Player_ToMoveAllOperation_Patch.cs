...
{
    internal class Player_ToMoveAllOperation_Patch : ModuleReplicationPatch
    {
        public override Type InstanceType => typeof(EFT.Player);
        public override string MethodName => "ToMoveAllOperation";
        protected override MethodBase GetTargetMethod() => ReflectionHelpers.GetMethodForType(InstanceType, MethodName);

        [PatchPostfix]
        public static void PostPatch(ItemController __instance, MoveAllOperationDescriptor descriptor)
        {
            var coopPlayer = Singleton<GameWorld>.Instance.MainPlayer as CoopPlayer;
            Logger.LogInfo("Player_ToMoveAllOperation_Patch");
            ...
            {
                Logger.LogError("Player_ToMoveAllOperation_Patch::PostPatch CoopPlayer was null!");
            }
        }
